...
<option style="unicode-bidi: bidi-override; direction: ltr" value="/php/index.php?lang=en&pr=Y" selected>English (English) </option>
...
<li><a href="index.php@lang=en">TOP</a></li>
<li><a href="index.php@tag=--&amp;lang=en">SIGNS</a></li>
<li><a href="index.php@tag=---&amp;lang=en">AUXILIARIES</a></li>
<li><a href="index.php@tag=0&amp;lang=en">0</a></li>
<li><a href="index.php@tag=1&amp;lang=en">1</a></li>
<li><a href="index.php@tag=2&amp;lang=en">2</a></li>
<li><a href="index.php@tag=3&amp;lang=en">3</a></li>
<li><a  class="vacant" href="index.php#">4</a></li>
<li><a href="index.php@tag=5&amp;lang=en">5</a></li>
<li><a href="index.php@tag=6&amp;lang=en">6</a></li>
<li><a href="index.php@tag=7&amp;lang=en">7</a></li>
<li><a href="index.php@tag=8&amp;lang=en">8</a></li>
<li><a href="index.php@tag=9&amp;lang=en">9</a></li>
</ul>
<input type="hidden" id="if_loading" name="if_loading" value="Loading"/>
<input type="hidden" id="if_lang" name="if_lang" value="1"/>
<ul class="rightmenu boldmenu">
<li><a href="../translation.htm">TRANSLATIONS</a></li>
<li><a href="index.php#" title="Under Development">MAPPINGS</a></li>
<li><a href="../exports.htm" title="Data Exports">EXPORTS</a></li>
<li><a href="index.php#" title="Under Development">ABC INDEX</a></li>
<li><a href="index.php#" title="Under Development">GUIDE</a></li>
...
<!--
d = new dTree('d');
d.add(0,-1,'','<span class="nodetag"></span>TOP','',false);
d.add(1,0,'-','<div class="nodetag"></div></span>&nbsp;&nbsp;AUXILIARY TABLES','','AUXILIARY TABLES','','','',true,false);
d.add(2,1,'--','<div class="nodetag"></div></span>&nbsp;&nbsp;COMMON AUXILIARY SIGNS','index.php?id=78885&lang=en','COMMON AUXILIARY SIGNS','','','',true,false);
d.add(3,2,'+','<div class="nodetag">+</div></span>&nbsp;&nbsp;Coordination. Addition (plus sign). Table 1a','+','Coordination. Addition (plus sign). Table 1a','','','',true,true);
d.add(4,2,'/','<div class="nodetag">/</div></span>&nbsp;&nbsp;Consecutive extension (oblique stroke sign). Table 1a','/','Consecutive extension (oblique stroke sign). Table 1a','','','',true,true);
d.add(5,2,':','<div class="nodetag">:</div></span>&nbsp;&nbsp;Simple relation (colon sign). Table 1b',':','Simple relation (colon sign). Table 1b','','','',true,true);
d.add(6,2,'::','<div class="nodetag">::</div></span>&nbsp;&nbsp;Order-fixing (double colon sign). Table 1b','::','Order-fixing (double colon sign). Table 1b','','','',true,true);
d.add(7,2,'[]','<div class="nodetag">[]</div></span>&nbsp;&nbsp;Subgrouping (square brackets). Table 1b','[]','Subgrouping (square brackets). Table 1b','','','',true,true);
d.add(8,2,'*','<div class="nodetag">*</div></span>&nbsp;&nbsp;Introduces non-UDC notation (asterisk). Table 1h','*','Introduces non-UDC notation (asterisk). Table 1h','','','',true,true);
d.add(9,2,'A/Z','<div class="nodetag">A/Z</div></span>&nbsp;&nbsp;Direct alphabetical specification. Table 1h','A/Z','Direct alphabetical specification. Table 1h','','','',true,true);
d.add(10,1,'---','<div class="nodetag"></div></span>&nbsp;&nbsp;COMMON AUXILIARY NUMBERS','','COMMON AUXILIARY NUMBERS','','','',true,false);
d.add(11,10,'=...','<div class="nodetag">=...</div></span>&nbsp;&nbsp;Common auxiliaries of language. Table 1c','index.php?id=8&lang=en','Common auxiliaries of language. Table 1c','','','',true,false);
d.add(12,10,'(0...)','<div class="nodetag">(0...)</div></span>&nbsp;&nbsp;Common auxiliaries of form. Table 1d','index.php?id=1585&lang=en','Common auxiliaries of form. Table 1d','','','',true,false);
d.add(13,10,'(1/9)','<div class="nodetag">(1/9)</div></span>&nbsp;&nbsp;Common auxiliaries of place. Table 1e','index.php?id=1951&lang=en','Common auxiliaries of place. Table 1e','','','',true,false);
d.add(14,10,'(=...)','<div class="nodetag">(=...)</div></span>&nbsp;&nbsp;Common auxiliaries of human ancestry, ethnic grouping and nationality. Table 1f','index.php?id=11755&lang=en','Common auxiliaries of human ancestry, ethnic grouping and nationality. Table 1f','','','',true,false);
d.add(15,10,'"..."','<div class="nodetag">"..."</div></span>&nbsp;&nbsp;Common auxiliaries of time. Table 1g','index.php?id=11472&lang=en','Common auxiliaries of time. Table 1g','','','',true,false);
d.add(16,10,'-0...','<div class="nodetag">-0...</div></span>&nbsp;&nbsp;Common auxiliaries of general characteristics: Properties, Materials, Relations/Processes and Persons. Table 1k.','index.php?id=11791&lang=en','Common auxiliaries of general characteristics: Properties, Materials, Relations/Processes and Persons. Table 1k.','','','',true,false);
d.add(17,0,'----','<div class="nodetag"></div></span>&nbsp;&nbsp;MAIN TABLES','','MAIN TABLES','','','',true,false);
d.add(18,17,'0','<div class="nodetag">0</div></span>&nbsp;&nbsp;SCIENCE AND KNOWLEDGE. ORGANIZATION. COMPUTER SCIENCE. INFORMATION. DOCUMENTATION. LIBRARIANSHIP. INSTITUTIONS. PUBLICATIONS','index.php?id=13358&lang=en','SCIENCE AND KNOWLEDGE. ORGANIZATION. COMPUTER SCIENCE. INFORMATION. DOCUMENTATION. LIBRARIANSHIP. INSTITUTIONS. PUBLICATIONS','','','',true,false);
d.add(19,17,'1','<div class="nodetag">1</div></span>&nbsp;&nbsp;PHILOSOPHY. PSYCHOLOGY','index.php?id=15164&lang=en','PHILOSOPHY. PSYCHOLOGY','','','',true,false);
d.add(20,17,'2','<div class="nodetag">2</div></span>&nbsp;&nbsp;RELIGION. THEOLOGY','index.php?id=15988&lang=en','RELIGION. THEOLOGY','','','',true,false);
d.add(21,17,'3','<div class="nodetag">3</div></span>&nbsp;&nbsp;SOCIAL SCIENCES','index.php?id=18549&lang=en','SOCIAL SCIENCES','','','',true,false);
d.add(22,17,'5','<div class="nodetag">5</div></span>&nbsp;&nbsp;MATHEMATICS. NATURAL SCIENCES','index.php?id=25403&lang=en','MATHEMATICS. NATURAL SCIENCES','','','',true,false);
d.add(23,17,'6','<div class="nodetag">6</div></span>&nbsp;&nbsp;APPLIED SCIENCES. MEDICINE. TECHNOLOGY','index.php?id=37275&lang=en','APPLIED SCIENCES. MEDICINE. TECHNOLOGY','','','',true,false);
d.add(24,17,'7','<div class="nodetag">7</div></span>&nbsp;&nbsp;THE ARTS. RECREATION. ENTERTAINMENT. SPORT','index.php?id=64676&lang=en','THE ARTS. RECREATION. ENTERTAINMENT. SPORT','','','',true,false);
d.add(25,17,'8','<div class="nodetag">8</div></span>&nbsp;&nbsp;LANGUAGE. LINGUISTICS. LITERATURE','index.php?id=67277&lang=en','LANGUAGE. LINGUISTICS. LITERATURE','','','',true,false);
d.add(26,17,'9','<div class="nodetag">9</div></span>&nbsp;&nbsp;GEOGRAPHY. BIOGRAPHY. HISTORY','index.php?id=68076&lang=en','GEOGRAPHY. BIOGRAPHY. HISTORY','','','',true,false);
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-13138465-1");
